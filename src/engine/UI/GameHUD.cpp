...
void GameHUD::addLines(const std::string &text, int lineCount, const Args &... args) {
    printBuilder().print(lineOffset, lineOffset + lineHeight * currentLines, string_utils::formatString(text, args...));
